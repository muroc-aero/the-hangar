"""Built-in aircraft data templates for OpenConcept MCP tools.

Each template is a nested dict matching the OpenConcept ``data = {"ac": {...}}``
convention, plus metadata about the default propulsion architecture.
"""
...
# ---------------------------------------------------------------------------
# Cessna Caravan (single turboprop)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Boeing 737-800 (twin turbofan -- uses CFM56 in OpenConcept)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Beechcraft King Air C90GT (twin turboprop, hybrid-ready)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# SOCATA TBM 850 (single turboprop, fast)
# ---------------------------------------------------------------------------
...
AIRCRAFT_TEMPLATES: dict[str, dict] = {
    "caravan": {
        "data": _CARAVAN_DATA,
        "default_architecture": "turboprop",
        "description": "Cessna 208 Caravan -- single-engine turboprop utility aircraft",
        "category": "GA turboprop",
        "summary": {
            "MTOW_kg": 3970,
            "propulsion": "1x PT6A-114A (675 hp)",
            "wing_area_m2": 26.0,
            "pax": 2,
        },
    },
    "b738": {
        "data": _B738_DATA,
        "default_architecture": "twin_turbofan",
        "description": "Boeing 737-800 -- twin-engine narrow-body jet transport",
        "category": "Jet transport",
        "summary": {
            "MTOW_kg": 79002,
            "propulsion": "2x CFM56-7B (27,000 lbf)",
            "wing_area_m2": 124.6,
            "pax": 180,
        },
    },
    "kingair": {
        "data": _KINGAIR_DATA,
        "default_architecture": "twin_turboprop",
        "description": "Beechcraft King Air C90GT -- twin turboprop, hybrid-ready",
        "category": "Twin turboprop",
        "summary": {
            "MTOW_kg": 4581,
            "propulsion": "2x PT6A-135A (750 hp)",
            "wing_area_m2": 27.308,
            "pax": 8,
        },
    },
    "tbm850": {
        "data": _TBM850_DATA,
        "default_architecture": "turboprop",
        "description": "SOCATA TBM 850 -- fast single-engine turboprop",
        "category": "Fast turboprop",
        "summary": {
            "MTOW_kg": 3353,
            "propulsion": "1x PT6A-66D (850 hp)",
            "wing_area_m2": 18.0,
            "pax": 6,
        },
    },

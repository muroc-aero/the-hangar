...
from hangar.evt.state import artifacts as _artifacts
...
async def reference_guide() -> str:
    """Return the evt parameter reference document."""
    return (_PKG_DIR / "reference.md").read_text(encoding="utf-8")


async def workflow_guide() -> str:
    """Return the evt step-by-step workflow guide."""
